...
async def main_loop():
    ...
    while True:
        ...
        for category, url in RSS_FEEDS.items():
            ...
            # Проходим по новостям в обратном порядке, чтобы публиковать сначала более старые
            for entry in reversed(feed.entries):
                if entry.link not in posted_urls:
                    print(f"🔍 Найдена новая статья: {entry.title}")
                    
                    # Получаем обработанный текст от ИИ
        ...
        # Пауза перед следующей большой проверкой всех RSS-лент
